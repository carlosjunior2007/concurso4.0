...
// mensaje de inicio para el jugador 
  if(a===2){
    ...
    textSize(45);
    text("Al llegar a 40 puntos tendras una habilidad extra",displayWidth/2,displayHeight/2);
    text("Presiona la tecla r para iniciar",displayWidth/2,displayHeight-500);
    enemigosg.destroyEach();
